...
<div class="form-group">
    ...
    <select class="form-control" id="edad" name="edad">
        ...
        <option value="51-55 años">51-55 años</option>

        <option value="56-60 años">56-60 años</option>

        <option value="61-65 años">61-65 años</option>

        <option value="66-70 años">66-70 años</option>
