                ...
                <tbody>
                    ...
                    <tr class="text-center">
                        ...
                        <td scope="row">¿Accidente que tenga como consecuencia la muerte, la pérdida de un miembro o una
                            lesión grave?</td>
                        <td scope="row">{{ $registroID->ets_1 }}</td>
                        <td scope="row">{{ $registroID->ets_1 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">43</th>
                        <td scope="row">¿Asaltos?</td>
                        <td scope="row">{{ $registroID->ets_2 }}</td>
                        <td scope="row">{{ $registroID->ets_2 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">44</th>
                        <td scope="row">¿Actos violentos que derivaron en lesiones graves?</td>
                        <td scope="row">{{ $registroID->ets_3 }}</td>
                        <td scope="row">{{ $registroID->ets_3 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">45</th>
                        <td scope="row">¿Secuestro?</td>
                        <td scope="row">{{ $registroID->ets_4 }}</td>
                        <td scope="row">{{ $registroID->ets_4 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">46</th>
                        <td scope="row">¿Amenazas?</td>
                        <td scope="row">{{ $registroID->ets_5 }}</td>
                        <td scope="row">{{ $registroID->ets_5 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">47</th>
                        ...
                        <td scope="row">{{ $registroID->ets_6 }}</td>
                        <td scope="row">{{ $registroID->ets_6 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">48</th>
                        <td scope="row">¿Ha tenido recuerdos recurrentes sobre el acontecimiento que le provocan
                            malestares?</td>
                        <td scope="row">{{ $registroID->ets_7 }}</td>
                        <td scope="row">{{ $registroID->ets_7 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">49</th>
                        ...
                        <td scope="row">{{ $registroID->ets_8 }}</td>
                        <td scope="row">{{ $registroID->ets_8 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">50</th>
                        ...
                        <td scope="row">{{ $registroID->ets_9 }}</td>
                        <td scope="row">{{ $registroID->ets_9 }}</td>
                    </tr>
                    <tr class="text-center">
                        <th scope="row">51</th>
