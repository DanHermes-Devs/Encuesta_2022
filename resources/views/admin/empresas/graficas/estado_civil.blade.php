<div class="col-12 col-md-4 mt-4">
    <canvas id="civil" width="400" height="400"></canvas>
</div>
...
@php
    ...
    foreach ($estudios as $key => $value){
        ...
        $estudios_academicos = array($estudio => count($value->estado_civil));
...
<script>
    ...
    var estudios = document.getElementById('civil').getContext('2d');
