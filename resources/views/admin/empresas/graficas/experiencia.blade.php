<div class="col-12 col-md-4 mt-4">
    <canvas id="experiencia" width="400" height="400"></canvas>
</div>
...
@php
    ...
    foreach ($estudios as $key => $value){
        $estudio = $value->experiencia_laboral;
        ...
        $estudios_academicos = array($estudio => count($value->experiencia_laboral));
...
<script>
    ...
    var estudios = document.getElementById('experiencia').getContext('2d');
