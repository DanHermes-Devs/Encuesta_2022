...
@php
    ...
    foreach($Otiempo as $value){
        if ($value->c_cat_3 < 5){
            $nulo+=1;
        }else if ($value->c_cat_3 <= 5 || $value->c_cat_3 < 7){
            $bajo+=1;
        }else if ($value->c_cat_3 <= 7 || $value->c_cat_3 < 10){
            $medio+=1;
        }else if ($value->c_cat_3 <= 10 || $value->c_cat_3 < 13){
            $alto+=1;
        }else if ($value->c_cat_3 >= 13){
            $muyalto+=1;
        }
    }
@endphp
