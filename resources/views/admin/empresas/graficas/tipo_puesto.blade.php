<div class="col-12 col-md-4 mt-4">
    <canvas id="tipo_puesto" width="400" height="400"></canvas>
</div>
...
@php
    ...
    foreach ($estudios as $key => $value){
        ...
        $estudios_academicos = array($estudio => count($value->tipo_puesto));
...
<script>
    ...
    var estudios = document.getElementById('tipo_puesto').getContext('2d');
